      ...
      <main className={styles.main}>
        ...
        <Flex direction={['column','column','row','row']} w={"100vw"} align='center' justify='center' p="4">
          <Flex direction={'column'} align='center' m={5}>
            ...
            <a href="https://github.com/keflynn" target="_blank"  rel="noreferrer" align="center"> <Image src="/GitHub-Mark-64px.png" alt="kelseyGitHub" width="50" height="50"/></a>
          </Flex>
          <Flex m={5} direction={'column'} align='center'>
            <Image src='https://avatars.githubusercontent.com/u/12378147?v=4' alt="Rosio" width="250" height="250"/>
            <h2 align="center">Rosio Reyes</h2>
            <a href="https://github.com/RRosio" target="_blank"  rel="noreferrer" align="center"> <Image src="/GitHub-Mark-64px.png" alt="rosioGitHub" width="50" height="50"/></a>
          </Flex>
          <Flex m={5} direction={'column'} align='center'>
            <Image src='https://avatars.githubusercontent.com/u/64326677?v=4' alt="Heeho" width="250" height="250"/>
            <h2 align="center">Heeho Kang</h2>
            <a href="https://github.com/Murphypie" target="_blank"  rel="noreferrer" align="center"> <Image src="/GitHub-Mark-64px.png" alt="heehoGitHub" width="50" height="50"/></a>
          </Flex>
          <Flex m={5} direction={'column'} align='center'>
            <Image src='https://avatars.githubusercontent.com/u/33673616?v=4' alt="Miklos" width="250" height="250"/>
            <h2 align="center">Miklós Kertész</h2>
            <a href="https://github.com/mikloska" target="_blank"  rel="noreferrer" align="center"> <Image src="/GitHub-Mark-64px.png" alt="miklosGitHub" width="50" height="50"/></a>
          </Flex>
